...
<div class="topnav">
  ...
  <a href="bike.php" class="active">Bike</a>
  ...
  <form class="form-horizontal" action="bike.php" method="post">
...
<?php
    ...
    if(isset($_POST['submit'])){
      ...
      $query1 = "INSERT INTO Advertisement (item_name,item_type,date_of_init,date_of_exp,owner_id) VALUES ('$productName','$bike','$today','$expiry','$owner_email')";
      ...
      if($result1){
            ...
            $temp =  $row["advt_id"];
            $query3 = "INSERT INTO bikes(product_id,manufacturer,model_name,year_of_purchase,kilometers_driven,ad_description,expected_price)
             VALUES ('$temp','$manufacturer','$productName','$yearOfPurchase','$kdrive','$description','$expectedPrice')";
