...
<div class="topnav">
  ...
  <a href="audio.php"  class="active">Speakers</a>
  ...
  <form class="form-horizontal" action="audio.php" method="post">
    <div class="form-group">
      <label class="control-label col-sm-2 color-white" for="product_name" ><font color="black">Product Name</font></label>
      <div class="col-sm-10">
...
<?php
    ...
    if(isset($_POST['submit'])){
      ...
      $query1 = "INSERT INTO Advertisement (item_name,item_type,date_of_init,date_of_exp,owner_id) VALUES ('$productName','$speaker','$today','$expiry','$owner_email')";
      ...
      if($result1){
            ...
            $temp =  $row["advt_id"];
            $query3 = "INSERT INTO speakers (product_id,manufacturer,year_of_purchase,ad_description,expected_price)
             VALUES ('$temp','$manufacturer','$yearOfPurchase','$description',$expectedPrice)";
