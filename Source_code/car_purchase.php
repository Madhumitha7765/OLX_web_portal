...
<!-- Side navigation -->
<div class="sidenav">
  <a href="purchase.php">General</a>
  <a href="laptop_purchase.php">Laptop</a>
  <a href="mobile_purchase.php">Mobile</a>
  <a href="audio_purchase.php">Speakers</a>
  <a href="book_purchase.php">Books</a>
  <a href="bike_purchase.php">Bike</a>
  <a href="car_purchase.php">Cars</a>
  <a href="camera_purchase.php">Cameras</a>
  <a href="television_purchase.php">Television</a> 
                ...
                <div class="lib-panel">
                    <div class="row box-shadow">
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="lib-row lib-data">
                            	<p>Fuel Type: <b><?php echo $row2["fueltype"]; ?></b></p>
                            </div>
                            <div class="lib-row lib-data">
                            	<p>Kilometers Driven: <b><?php echo $row2["kilometers_driven"]; ?></b></p>
                            </div>
