        ...
        <div class="table-responsive">
            <table class="table table-bordered table-striped table-hover text-center">
                ...
                <?php
                   ...
                   $selectquery = "select a.advt_id,a.owner_id,b.model_name,b.manufacturer,b.year_of_purchase,b.inches,a.buyer_id from advertisement a inner join television b on a.advt_id=b.product_id;";
