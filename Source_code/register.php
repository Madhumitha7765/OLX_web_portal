...
<form action="register.php" method="post" class="form-container">
  ...
  <div class="form-group">
    <select class="form-control" id='user_type' name='user_type'>
      ...
      <option value="Student"><font color="black">Student</font></option>
      <option value="Staff"><font color="black">Staff</font></option>
      <option value="Faculty"><font color="black">Faculty</font></option>
    </select>
  </div>
  <div class="form-group">
