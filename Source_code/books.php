...
<div class="topnav">
  ...
  <form class="form-horizontal" action="books.php" method="post">
    <div class="form-group">
      <label class="control-label col-sm-2 color-white" for="name_of_book"><font color="black">Name of Book</font></label>
      <div class="col-sm-10">
        <input type="text" class="form-control" id="name_of_book" placeholder="Name of Book" name="name_of_book" required>
      </div>
    </div>
    <div class="form-group">
      <label class="control-label col-sm-2 color-white" for="author1"><font color="black">Author Name</font></label>
      <div class="col-sm-10">
    ...
    <div class="form-group">
      <label class="control-label col-sm-2 color-white" for="condition"><font color="black">Condition</font></label>
      <div class="col-sm-10">          
