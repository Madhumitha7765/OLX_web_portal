...
<div class="topnav">
  ...
  <a href="mobile.php" class="active">Mobile</a>
  ...
  <form class="form-horizontal" action="mobile.php" method="post">
    ...
    <div class="form-group">        
      <div class="col-sm-offset-2 col-sm-10">
        <button type="submit" name="submit" id="submit" class="btn btn-primary"><font color="black">Submit</font></button>
      </div>
    </div>
  </form>
</div>
...
<?php
    ...
    if(isset($_POST['submit'])){
      ...
      //$target = "images/".basename($_FILES['image']['name']);//path to store image
