        ...
        <div class="table-responsive">
            <table class="table table-bordered table-striped table-hover text-center">
                ...
                <?php
                   ...
                   $selectquery = "select a.advt_id,a.owner_id,b.manufacturer,b.year_of_purchase,a.buyer_id from advertisement a inner join speakers b on a.advt_id=b.product_id;";
