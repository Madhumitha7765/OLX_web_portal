        ...
        <div class="table-responsive">
            <table class="table table-bordered table-striped table-hover text-center">
                ...
                <?php
                   ...
                   $selectquery = "select a.advt_id,a.owner_id,b.model_name,b.manufacturer,b.year_of_purchase,b.battery_status,a.buyer_id from advertisement a inner join camera b on a.advt_id=b.product_id;";
