...
<div class="topnav">
  ...
  <a href="camera.php" class="active">Cameras</a>
  ...
  <form class="form-horizontal" action="camera.php" method="post">
    ...
    <div class="form-group">
      <label class="control-label col-sm-2 color-white" for="battery_status"><font color="black">Battery Status</font></label>
      <div class="col-sm-10">          
...
<?php
    ...
    if(isset($_POST['submit'])){
      ...
      $query1 = "INSERT INTO Advertisement (item_name,item_type,date_of_init,date_of_exp,owner_id) VALUES ('$productName','$camera','$today','$expiry','$owner_email')";
      ...
      if($result1){
            ...
            $temp =  $row["advt_id"];
            $query3 = "INSERT INTO camera (product_id,manufacturer,model_name,year_of_purchase,battery_status,ad_description,expected_price)
